...
const ContactUsNew = () => {
  return (
    <>
      ...
      <section
        className="pt-32 pb-24 min-h-screen flex items-center justify-center bg-cover bg-center relative"
        style={{
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/40 dark:bg-black/50 z-0"></div>

        <div className="container mx-auto px-6 bg-white/90 dark:bg-gray-800/90 shadow-lg rounded-lg p-6 w-full max-w-4xl h-full min-h-screen flex flex-col justify-center z-10">
          {/* Contact Us Heading */}
          <div className="text-center mb-6 bg-white/80 dark:bg-gray-800/80 py-6 z-20 shadow-md rounded-lg">
            <motion.h2
          ...
          <div className="flex flex-col md:flex-row md:justify-between w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 z-10">
            {/* Contact Info */}
            <motion.div
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-medical text-white py-3 rounded-lg hover:bg-medical-dark transition-all"
              >
                Submit Feedback
              </button>
            </motion.form>
